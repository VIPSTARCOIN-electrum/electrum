...
pushd $WINEPREFIX/drive_c/electrum-vips
...
for i in ./locale/*; do
    dir=$WINEPREFIX/drive_c/electrum-vips/electrum/$i/LC_MESSAGES
    mkdir -p $dir
...
cd dist
mv electrum-vips-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
