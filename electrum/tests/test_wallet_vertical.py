...
class TestWalletSending(TestCaseForTestnet):
    ...
    def test_sending_between_p2wsh_2of3_and_p2wsh_p2sh_2of2(self, mock_write):
        ...
        txid = tx.txid()
        partial_tx = tx.serialize_as_bytes().hex()
        self.assertEqual("",
                         partial_tx)
        tx = tx_from_any(partial_tx)  # simulates moving partial txn between cosigners
        self.assertEqual(txid, tx.txid())
        self.assertFalse(tx.is_complete())
        ...
        self.assertEqual('',
                         str(tx_copy))
        self.assertEqual('ac299b4bf37c98358be98dd71117297f49d213aad841039e2bef08173f5f6b7b', tx_copy.txid())
        self.assertEqual('452f99730e0bc12fc898e34e93c21438882c658cce030271646d14efe2d8b65e', tx_copy.wtxid())
        self.assertEqual(tx.wtxid(), tx_copy.wtxid())
        self.assertEqual(txid, tx_copy.txid())
    ...
    def _rbf_batching(self, *, simulate_moving_txs):
        ...
        self.assertEqual(tx.txid(), tx_copy.txid())
        self.assertEqual(tx.wtxid(), tx_copy.wtxid())
        self.assertEqual('',
                         str(tx_copy))
        self.assertEqual('8e04722986a878a2b3473835c21e1bd2c7902ab03d36d3a5c5913873eeb4a04d', tx_copy.txid())
        self.assertEqual('5c1f365fe33d77cf3ce42c438a0452e21861c675c83545f65d004a5429e9db91', tx_copy.wtxid())
        ...
        self.assertEqual(tx.txid(), tx_copy.txid())
        self.assertEqual(tx.wtxid(), tx_copy.wtxid())
        self.assertEqual('',
                         str(tx_copy))
        self.assertEqual('1a7834b4469cbfdf1c12441f8e787ba70ce9ce421ca7ebec8a2a6fcdfe98dbcc', tx_copy.txid())
        self.assertEqual('367bb1a873c2c06a5051b2688b0661fd35c5e68c16b4ffcaff4d50bf958e1a8b', tx_copy.wtxid())
