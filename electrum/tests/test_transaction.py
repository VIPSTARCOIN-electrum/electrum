...
class TestTransaction(ElectrumTestCase):
    ...
    def test_tx_deserialize_for_signed_network_tx(self):
        ...
        self.assertEqual('VDrWUBSMgMju5HprzZ8yA8gukn1ZXS5Sa6', tx.outputs()[0].address)
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(estimated_output_size('VLraoaGfGAqPBhiRLWR2eeRbjTJp9zZYH7'), 34)
        self.assertEqual(estimated_output_size('MBmyiC29MUQSfPC2gKtdrazbSWHvGqJCnU'), 32)
        self.assertEqual(estimated_output_size('vips1qla2utmapxptpj4jer2sdyx26ypgvwj978rmukl'), 31)
        self.assertEqual(estimated_output_size('vips1qhg020wxv9904wuklu640akyqhaj4ynks0nnarlme4n5n5du7w50s7wfws2'), 43)
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual('vips1qw508d6qejxtdg4y5r3zarvary0c5xw7kt9g2vs', addr_from_script('0014751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('vips1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7kasxad6', addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('vips1sw50q09fch2', addr_from_script('6002751e'))
        self.assertEqual('vips1zw508d6qejxtdg4y5r3zarvaryvl872h2', addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
        # almost but not quite
        self.assertEqual(None, addr_from_script('0013751e76e8199196d454941c45d1b3a323f1433b'))

        # base58 p2pkh
        self.assertEqual('VELqMQnzSqEbzY8FSHiVsiAiw79gU8Azt9', addr_from_script('76a91428662c67561b95c79d2257d2a93d9d151c977e9188ac'))
        self.assertEqual('VLu4bbZEEgSKb9diz5FK7etfHdXXr8AKXt', addr_from_script('76a914704f4b81cadb7bf7e68c08cd3657220f680f863c88ac'))
        # almost but not quite
