...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D'})

    def test_parse_URI_only_address(self):
        self._do_test_parse_URI('VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D'})


    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?label=electrum%20test',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?message=electrum%20test',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'message': 'electrum test', 'memo': 'electrum test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?amount=0.0003',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?test=test',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
                                {'address': 'VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D', 'amount': 4000, 'label': 'electrum-test', 'message': u'electrum test', 'memo': u'electrum test', 'r': 'http://domain.tld/page', 'test': 'none'})

    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('vipstarcoin:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(BaseException, parse_URI, 'vipstarcoin:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notvipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D')

    def test_parse_URI_parameter_polution(self):
        self.assertRaises(Exception, parse_URI, 'vipstarcoin:VDazYa8f46NXsFRHHdT8XLrJErNYJtkC7D?amount=0.0003&label=test&amount=30.0')
